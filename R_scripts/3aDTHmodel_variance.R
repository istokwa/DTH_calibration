...
actfilename = "(12-15-2025)-Var-BASE"
...
OptParams <- read_excel("data/processed/DVRparams.xlsx")
...
numeric_cols <- c("G","Th","Lc","A","B","MSE", "DTH1", "DTH2", "DTH3", "MODEL1", "MODEL2", "MODEL3")
...
facet_levels <- c("G", "Th", "Lc", "A", "B", "MSE")
